...
- ☁️ Technical Team Lead for the **AWS Cloud Student Ambassador** program, teaching cloud/AI fundamentals to 100+ students
- 🌱 Currently working towards the **HackTheBox Certified Penetration Testing Specialist** certification
- 📫 Reach me at mmahad2-c@my.cityu.edu.hk or [LinkedIn](https://www.linkedin.com/in/muhammad-mahad-16a115246/)
...
| Project | Description |
|---|---|
| [**Agentic AI for Cyber Security**](https://github.com/muhammadmahad4) | Final Year Project — hardened OpenClaw agentic AI deployment (Docker/Kubernetes) automating recon, log analysis, and threat correlation |
| [**Auto-Emailing Website**](https://github.com/muhammadmahad4/Auto-Emailer) | Full-stack email automation tool using Google OAuth and the DeepSeek API, cutting job application time by 90% |
| [**Collaborative Whiteboard**](https://github.com/muhammadmahad4/Collaborative-Whiteboard) | Real-time collaborative whiteboard with live drawing, chat, and theming — built with Node.js and WebSockets |
